...
export const ElementWrapper = ({
  ...
  children,
  draggable,
}: PropsWithChildren<{ id: string; draggable: boolean }>) => {
  ...
  return (
    <div
      className="flex bg-gray-50 cursor-grab items-center gap-x-2 border border-gray-400 border-dashed hover:border-blue-300 hover:bg-blue-50/20 transition-all rounded-md p-2"
      draggable={draggable}
      {...listeners}
      {...attributes}
      ref={setNodeRef}
